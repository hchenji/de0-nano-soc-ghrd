...
module soc_system_mm_interconnect_2 (
		...
		input  wire [14:0] lw_mm_bridge_m0_address,                        //                          lw_mm_bridge_m0.address
	...
	wire   [14:0] lw_mm_bridge_m0_translator_avalon_universal_master_0_address;       // lw_mm_bridge_m0_translator:uav_address -> lw_mm_bridge_m0_agent:av_address
	...
	wire   [14:0] intr_capturer_0_avalon_slave_0_agent_m0_address;                    // intr_capturer_0_avalon_slave_0_agent:m0_address -> intr_capturer_0_avalon_slave_0_translator:uav_address
	...
	wire   [90:0] intr_capturer_0_avalon_slave_0_agent_rf_source_data;                // intr_capturer_0_avalon_slave_0_agent:rf_source_data -> intr_capturer_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire   [90:0] intr_capturer_0_avalon_slave_0_agent_rsp_fifo_out_data;             // intr_capturer_0_avalon_slave_0_agent_rsp_fifo:out_data -> intr_capturer_0_avalon_slave_0_agent:rf_sink_data
	...
	wire   [89:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> intr_capturer_0_avalon_slave_0_agent:cp_data
	wire          cmd_mux_001_src_ready;                                              // intr_capturer_0_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> intr_capturer_0_avalon_slave_0_agent:cp_channel
	...
	wire   [14:0] sysid_qsys_control_slave_agent_m0_address;                          // sysid_qsys_control_slave_agent:m0_address -> sysid_qsys_control_slave_translator:uav_address
	...
	wire   [89:0] cmd_mux_002_src_data;                                               // cmd_mux_002:src_data -> sysid_qsys_control_slave_agent:cp_data
	...
	wire   [14:0] chip_id_read_mm_0_s0_agent_m0_address;                              // chip_id_read_mm_0_s0_agent:m0_address -> chip_id_read_mm_0_s0_translator:uav_address
	...
	wire  [126:0] chip_id_read_mm_0_s0_agent_rf_source_data;                          // chip_id_read_mm_0_s0_agent:rf_source_data -> chip_id_read_mm_0_s0_agent_rsp_fifo:in_data
	...
	wire  [126:0] chip_id_read_mm_0_s0_agent_rsp_fifo_out_data;                       // chip_id_read_mm_0_s0_agent_rsp_fifo:out_data -> chip_id_read_mm_0_s0_agent:rf_sink_data
	...
	wire   [89:0] cmd_mux_004_src_data;                                               // cmd_mux_004:src_data -> led_pio_s1_agent:cp_data
	...
	wire   [89:0] cmd_mux_005_src_data;                                               // cmd_mux_005:src_data -> dipsw_pio_s1_agent:cp_data
	...
	wire   [89:0] cmd_mux_006_src_data;                                               // cmd_mux_006:src_data -> button_pio_s1_agent:cp_data
	...
	wire   [89:0] lw_mm_bridge_m0_agent_cp_data;                                      // lw_mm_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire   [89:0] intr_capturer_0_avalon_slave_0_agent_rp_data;                       // intr_capturer_0_avalon_slave_0_agent:rp_data -> router_002:sink_data
	...
	wire  [125:0] chip_id_read_mm_0_s0_agent_rp_data;                                 // chip_id_read_mm_0_s0_agent:rp_data -> router_004:sink_data
	...
	wire   [89:0] dipsw_pio_s1_agent_rp_data;                                         // dipsw_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire   [89:0] button_pio_s1_agent_rp_data;                                        // button_pio_s1_agent:rp_data -> router_007:sink_data
	...
	wire   [89:0] router_src_data;                                                    // router:src_data -> lw_mm_bridge_m0_limiter:cmd_sink_data
	wire          router_src_ready;                                                   // lw_mm_bridge_m0_limiter:cmd_sink_ready -> router:src_ready
	wire    [6:0] router_src_channel;                                                 // router:src_channel -> lw_mm_bridge_m0_limiter:cmd_sink_channel
	...
	wire   [89:0] lw_mm_bridge_m0_limiter_cmd_src_data;                               // lw_mm_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          lw_mm_bridge_m0_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> lw_mm_bridge_m0_limiter:cmd_src_ready
	wire    [6:0] lw_mm_bridge_m0_limiter_cmd_src_channel;                            // lw_mm_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [89:0] rsp_mux_src_data;                                                   // rsp_mux:src_data -> lw_mm_bridge_m0_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                  // lw_mm_bridge_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [6:0] rsp_mux_src_channel;                                                // rsp_mux:src_channel -> lw_mm_bridge_m0_limiter:rsp_sink_channel
	...
	wire   [89:0] lw_mm_bridge_m0_limiter_rsp_src_data;                               // lw_mm_bridge_m0_limiter:rsp_src_data -> lw_mm_bridge_m0_agent:rp_data
	wire          lw_mm_bridge_m0_limiter_rsp_src_ready;                              // lw_mm_bridge_m0_agent:rp_ready -> lw_mm_bridge_m0_limiter:rsp_src_ready
	wire    [6:0] lw_mm_bridge_m0_limiter_rsp_src_channel;                            // lw_mm_bridge_m0_limiter:rsp_src_channel -> lw_mm_bridge_m0_agent:rp_channel
	...
	wire   [89:0] cmd_mux_003_src_data;                                               // cmd_mux_003:src_data -> chip_id_read_mm_0_s0_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                              // chip_id_read_mm_0_s0_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                            // cmd_mux_003:src_channel -> chip_id_read_mm_0_s0_cmd_width_adapter:in_channel
	...
	wire  [125:0] chip_id_read_mm_0_s0_cmd_width_adapter_src_data;                    // chip_id_read_mm_0_s0_cmd_width_adapter:out_data -> chip_id_read_mm_0_s0_agent:cp_data
	...
	wire    [6:0] chip_id_read_mm_0_s0_cmd_width_adapter_src_channel;                 // chip_id_read_mm_0_s0_cmd_width_adapter:out_channel -> chip_id_read_mm_0_s0_agent:cp_channel
	...
	wire  [125:0] router_004_src_data;                                                // router_004:src_data -> chip_id_read_mm_0_s0_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                               // chip_id_read_mm_0_s0_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [6:0] router_004_src_channel;                                             // router_004:src_channel -> chip_id_read_mm_0_s0_rsp_width_adapter:in_channel
	...
	wire   [89:0] chip_id_read_mm_0_s0_rsp_width_adapter_src_data;                    // chip_id_read_mm_0_s0_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	...
	wire    [6:0] chip_id_read_mm_0_s0_rsp_width_adapter_src_channel;                 // chip_id_read_mm_0_s0_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire    [6:0] lw_mm_bridge_m0_limiter_cmd_valid_data;                             // lw_mm_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
