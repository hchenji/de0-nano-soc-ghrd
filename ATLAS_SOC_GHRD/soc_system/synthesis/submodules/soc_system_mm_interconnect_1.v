...
module soc_system_mm_interconnect_1 (
		...
		output wire [14:0] lw_mm_bridge_s0_address,                                             //                                               lw_mm_bridge_s0.address
	...
	wire   [31:0] lw_mm_bridge_s0_agent_m0_address;                                           // lw_mm_bridge_s0_agent:m0_address -> lw_mm_bridge_s0_translator:uav_address
	...
	wire  [123:0] lw_mm_bridge_s0_agent_rf_source_data;                                       // lw_mm_bridge_s0_agent:rf_source_data -> lw_mm_bridge_s0_agent_rsp_fifo:in_data
	...
	wire  [123:0] lw_mm_bridge_s0_agent_rsp_fifo_out_data;                                    // lw_mm_bridge_s0_agent_rsp_fifo:out_data -> lw_mm_bridge_s0_agent:rf_sink_data
	...
	wire          lw_mm_bridge_s0_agent_rp_valid;                                             // lw_mm_bridge_s0_agent:rp_valid -> router_003:sink_valid
	wire  [122:0] lw_mm_bridge_s0_agent_rp_data;                                              // lw_mm_bridge_s0_agent:rp_data -> router_003:sink_data
	wire          lw_mm_bridge_s0_agent_rp_ready;                                             // router_003:sink_ready -> lw_mm_bridge_s0_agent:rp_ready
	wire          lw_mm_bridge_s0_agent_rp_startofpacket;                                     // lw_mm_bridge_s0_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          lw_mm_bridge_s0_agent_rp_endofpacket;                                       // lw_mm_bridge_s0_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [122:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> lw_mm_bridge_s0_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                          // lw_mm_bridge_s0_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> lw_mm_bridge_s0_burst_adapter:sink0_channel
	...
	wire  [122:0] lw_mm_bridge_s0_burst_adapter_source0_data;                                 // lw_mm_bridge_s0_burst_adapter:source0_data -> lw_mm_bridge_s0_agent:cp_data
	...
	wire    [2:0] lw_mm_bridge_s0_burst_adapter_source0_channel;                              // lw_mm_bridge_s0_burst_adapter:source0_channel -> lw_mm_bridge_s0_agent:cp_channel
